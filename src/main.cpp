...
int main(int argc, char **argv) {
  ...
  documentation
      << "\nAuthor:  Warren W Kretzschmar @ Marchini Group @ Univ. of Oxford.\n"
         ...
         "    -g, --gender-file <file> []\n"
         "        File that indicates which sex each sample is. Only used\n"
         "        for x chromosome. This option should be called --sex-file,\n"
         "        but is kept as --gender-file for backward compatibility.\n"
